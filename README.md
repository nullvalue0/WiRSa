...
2. Much simpler way is to download the precompiled binary at [/Firmware/WiRSa/WiRSa.bin](/Firmware/WiRSa/WiRSa.bin). Download [ESP32FlashTool](https://github.com/ClassicDIY/Esp32FlashTool/releases/tag/V1.0.0) and use it to upload the new version. In the ESP32FlashTool software, simply choose the COM port, select the .bin file, and click Flash.
